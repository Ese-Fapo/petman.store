...
const Newsletter = () => {
    return (
        <div className='flex flex-col items-center mx-4 my-36'>
            <Title title="Join the JUSTPETS Club" description="Get Irish pet-shop offers, new food arrivals, toy drops, and care essentials delivered straight to your inbox." visibleButton={false} />
